    ...
    >
      ...
      >
        <div
          ...
          // When collapsed to the icon rail, clicking anywhere in the sidebar
          // expands it (in addition to the trigger button + rail).
          onClick={state === "collapsed" ? () => setOpen(true) : undefined}
          className={cn(
